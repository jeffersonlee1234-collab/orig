...
export default function Reports() {
  ...
  const handleExport = () => {
    const lines = [
      ...
      [`Period: ${range}`],
      [`Data Privacy Status: ${maskPiiExport ? "MASKED PII (RA 10173 Compliant)" : "UNMASKED (Authorized Confidential)"}`],
      [],
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-blue-200 bg-blue-50/80 text-sm font-semibold text-blue-700 hover:bg-blue-100 transition-colors cursor-pointer shadow-2xs"
          >
