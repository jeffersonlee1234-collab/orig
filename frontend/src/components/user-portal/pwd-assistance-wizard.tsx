...
export default function PWDSocialAssistanceWizard({
  ...
  const [formData, setFormData] = useState<FormData>(() => {
    ...
    return {
      ...
      sex: userProfile.sex || (userProfile as any).gender || "Female",
      pwdIdNumber: "",
      disabilityType: "",
                  ...
                  return (
                    <div key={doc.id}>
                      ...
                      >
                        ...
                        {doc.note && (
                          <p className="text-xs text-amber-800 dark:text-amber-200 bg-amber-500/10 rounded-lg p-2 mt-1.5 border border-amber-500/30">
                            {doc.note}
                          </p>
                        )}
